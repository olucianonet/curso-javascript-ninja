# 09. Escopo, hoisting e IIFE

## Exercícios

9.1. Crie uma IIFE que envolva todo o código desse arquivo. Faça também a
...
function (){
    ...
    9.2. Analise as funções abaixo (`myFunction`, `myFunction2` e `myFunction3`, e
    ...
    */
    ...
    9.3. No desafio anterior criamos uma calculadora, usando uma estrutura funcional.
    ...
    */
    ...
    9.4. Declare uma variável chamada `sum`, e atribua a ela a função `calculator`,
    ...
    */
    ...
    9.5. Sabemos que `sum` agora tem uma função atribuída a ela, que é o retorno de
    ...
    */
    ...
    9.6. Agora declare outras variáveis chamadas `subtraction`, `multiplication`,
    ...
    */
    ...
    9.7. Mostre as variáveis acima no `console` (uma chamada de console por variável), criando a função de `callback` que faz o cálculo para subração, multiplicação, divisão e módulo (resto de divisão), conforme a função utilizada. As suas respostas devem estar abaixo dos `console.log` referentes à cada chamada.
